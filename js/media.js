...
function calcularMedia() {
  ...
  if (media ===0){
  mensagem= ("Infelimente voce zerou a prova")
  ...
  mensagem= (`Voce esta na media com ${media}`)
} else if (media=7.1 && media<=9.9){
  mensagem= (`Notao!Sua media é${media}`)
} else{
  mensagem= (`Hoje é seu aniversario?Pq voce esta de parabens! 10 na media`)
}
